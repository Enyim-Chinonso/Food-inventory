...
//         <button className="btn btn-primary ms-auto">+ Add Item</button>
//       </div>
...
//                     <div className="text-muted small">SKU: RICE-5KG</div>
//                   </td>
//                   <td>Grains</td>
//                   <td>120</td>
//                   <td>
...
//                   <td className="text-end">
//                     <Link
//                       href="/dashboard/inventory/2"
//                       className="btn btn-sm btn-outline-secondary me-2"
//                     >
//                       View
//                     </Link>
//                     <Link
//                       href="/dashboard/inventory/2/edit"
//                       className="btn btn-sm btn-outline-primary"
//                     >
//                       Edit
//                     </Link>
...
//                   <td className="text-end">
//                     <Link
//                       href="/dashboard/inventory/3"
//                       className="btn btn-sm btn-outline-secondary me-2"
//                     >
//                       View
//                     </Link>
//                     <Link
//                       href="/dashboard/inventory/3/edit"
//                       className="btn btn-sm btn-outline-primary"
//                     >
//                       Edit
//                     </Link>
...
//       <div className="text-muted small mb-1">Category: Grains</div>
//       <div className="text-muted small mb-1">Quantity: 120</div>
//       <div className="text-muted small mb-3">Expiry: 12 Aug 2025</div>
...
//                   <td>12 Aug 2025</td>
//                   <td className="text-end">
//                     <Link href="/dashboard/inventory/1" className="btn btn-sm btn-outline-secondary me-2">
//                       View
//                     </Link>
//                     <Link href="/dashboard/inventory/1/edit" className="btn btn-sm btn-outline-primary">
//                       Edit
//                     </Link>
//                   </td>
//                 </tr>
...
//             <div className="d-flex gap-2">
//               <Link href="/dashboard/inventory/1" className="btn btn-sm btn-outline-secondary w-50">
//                 View
//               </Link>
//               <Link href="/dashboard/inventory/1/edit" className="btn btn-sm btn-outline-primary w-50">
//                 Edit
//               </Link>
//             </div>
//           </div>
